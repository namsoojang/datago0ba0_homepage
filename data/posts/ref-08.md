...
> 💡 <strong>안내</strong>: 메세지배달부 Lite는 현재 Google Play Store에서 설치할 수 있습니다. 상세 설치 방법과 슬랙 웹후크 연동 가이드는 <strong>[메세지배달부 사용 가이드 페이지](/message-delivery)</strong>에서 확인하실 수 있습니다.
...
데이터공방은 메세지배달부 앱의 전송 품질과 서비스 안정성을 높이기 위해 향후 지속적인 디바이스 필드 테스트 피드백을 반영해 나갈 예정입니다. Play Store 설치 방법과 배터리 제한 해제 팁, 그리고 슬랙 연동 가이드가 필요하신 실무자분들께서는 데이터공방의 <strong>[메세지배달부 사용 가이드 페이지](/message-delivery)</strong>에서 상세 매뉴얼을 확인하실 수 있습니다.
